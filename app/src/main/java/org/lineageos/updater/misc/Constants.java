...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.nexus.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.nexus.device";
    ...
    public static final String PROP_UPDATER_URI = "nexus.updater.uri";
